...
This document outlines the lifecycle of Library Interfaces and the governance process that ensures their quality, utility, and sustainability.
...
**Step 4:** Initial draft created in `drafts/portfolio-v0.1.js`

**Step 5:** Several iterations based on feedback

**Step 6:** Reference implementation created

**Step 7:** Release candidate `portfolio-v0.9.js`

**Step 8:** Final review period

**Step 9:** Promotion to `interfaces/portfolio/portfolio-v1.0.js`
...
**Step 3:** PR with `marketing-v1.1.js` created

**Step 4:** Review and approval

**Step 5:** Release of `marketing-v1.1.0`
...
**Step 3:** Draft of `marketing-v2.0.js` created
...
**Step 7:** Release of `marketing-v2.0.0`
